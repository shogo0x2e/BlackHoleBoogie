...
void GetScreenPosition_float(float3 Position, out float2 ScreenPosition,
                             out float2 ScreenPositionAspectRation)
{
  ...
  ScreenPositionAspectRation = float2(ScreenPosition.x, ScreenPosition.y * aspectRatio);
}
